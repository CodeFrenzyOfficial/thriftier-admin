<template>
  <div
    class="relative flex flex-row w-full overflow-hidden bg-gradient-to-r from-blue-900 h-screen to-blue-800 dark:to-blue-900 dark:from-blue-95"
  >
    ...
    >
      <div class="flex flex-col h-full">
        ...
        <div class="my-auto">
          <div class="mt-8">
            <h4 class="mb-2 text-primary text-xl font-semibold">
              Set a New Password
            </h4>
          ...
          <form action="/">
            ...
            <div class="flex items-center gap-2 mt-4">
              ...
              <label class="text-default-900 text-sm font-medium" for="check"
                >Remember me</label
              >
            </div>
            <div class="mt-8">
